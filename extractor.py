...
'''
                                    Extract Information from Egyptian National ID
                                     ...
                                     x (3) is the birth century (2 represent 1900 to 1999,
                                      3 represent  2000 to 2099 .. etc)

                                    yymmdd (200115) is the date of birth, yy(99) year,
                                     mm(01) month, dd(15) day

                                    ss(01)  birth governorate coda (88 for people who born
                                     in a foreign country, 01 for who born in cairo, ...etc )

                                    iiig(0192) the sequence in computer between births
                                     in this birthday and g(2) represent the gender
                                     (2,4,6,8 for females and 1,3,5,7,9)
